...
public final class ActivityPlacementBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityPlacementBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPlacementBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_placement, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPlacementBinding bind(@NonNull View rootView) {
