...
public final class ItemSingleChoiceBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RadioGroup rgQuiz;
  ...
  @NonNull
  public static ItemSingleChoiceBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  @NonNull
  public static ItemSingleChoiceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rg_quiz;
      RadioGroup rgQuiz = ViewBindings.findChildViewById(rootView, id);
      if (rgQuiz == null) {
        break missingId;
      }
